import {Not} from "sequelize-typescript/dist/browser";
...
describe("unit tests for notifications", () => {
    ...
    it("should create errors", () => {
        ...
        /* Se recebermos a mensagem "ID is required", o "context" mostra se o ID é de
        * "customer" ou de "order", por exemplo. */
        const error = {
